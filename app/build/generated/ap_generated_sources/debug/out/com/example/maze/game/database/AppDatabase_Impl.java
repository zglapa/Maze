  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Player` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `player_name` TEXT, `level` INTEGER NOT NULL, `time` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '65fdd88085884a73f8534b08e010e2bc')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsPlayer = new HashMap<String, TableInfo.Column>(4);
        ...
        _columnsPlayer.put("time", new TableInfo.Column("time", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoPlayer.equals(_existingPlayer)) {
          return new RoomOpenHelper.ValidationResult(false, "Player(com.example.maze.game.database.Player).\n"
                  + " Expected:\n" + _infoPlayer + "\n"
                  + " Found:\n" + _existingPlayer);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "65fdd88085884a73f8534b08e010e2bc", "0d52172507e391756bc6a700d489aaed");
